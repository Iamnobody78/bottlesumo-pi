...
@router.get("/agents")
def list_agents(engine=Depends(get_engine())):
...
@router.get("/policies")
def list_policies(engine=Depends(get_engine())):
...
def vce_latest(engine=Depends(get_engine())):
...
def vce_scan(engine=Depends(get_engine())):
